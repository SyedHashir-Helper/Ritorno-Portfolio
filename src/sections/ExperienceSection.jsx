  ...
  const projects = [
    {
      ...
      subtitle: "Next-Gen Medical Intelligence",
      description: "Revolutionary AI-powered medical diagnosis assistant that helps doctors make faster, more accurate decisions using advanced machine learning, computer vision, and natural language processing to analyze medical data and provide intelligent recommendations.",
      image: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&h=400&fit=crop",
      technologies: ["Python", "TensorFlow", "React", "AWS", "Computer Vision", "NLP"],
    ...
    },
    {
      ...
      subtitle: "Intelligent Wealth Management",
      description: "Advanced financial advisor chatbot that provides personalized investment recommendations, portfolio management, and risk assessment using sophisticated NLP, market analysis algorithms, and real-time data processing for optimal financial outcomes.",
      image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&h=400&fit=crop",
      technologies: ["Node.js", "OpenAI", "MongoDB", "React", "Trading APIs", "Risk Analytics"],
      category: "FinTech AI",
